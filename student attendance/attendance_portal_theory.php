...
<body>
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="#">
     <h1> ATTENDANCE PORTAL OF THEORY CLASS</h1>
    </a>
  </div>
</nav>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-control" name="semester" id="sem">
                                    ...
                                    <?php
                                            ...
                                            {
                                                echo "<option id='7TH SEMESTER' value='7TH SEMESTER'>7TH SEMESTER</option>
                                                    <option id='8TH SEMESTER' value='8TH SEMESTER'>8TH SEMESTER</option>";
                                            }
                                        ?>
                                    </SELECT>   
                            </div>
                                ...
                                <select class="form-control" id="sub">
                                    <option value="" name="subject">SELECT SUBJECT</option>
                                            <?php
                                                    ...
                                                    $query="select SUB_THEORY_ID,subjectname from subject_theory where SUB_THEORY_ID in 
                                                    (select sub_theory_id from teaches_theory where TEACHER_ID='$t_id') and ye_ar='$year';";
                    ...
                    <div class="card-body" align="center">
                        <input class="btn btn-primary insertbtn2" type="submit" value="ADD ATTENDANCE">
                    </div>
                </div>
            </div>
        </div>
            ...
            $(document).on("click", ".insertbtn2", function () 
            {
                ...
                var f=1;
                    ...
                    $.ajax(
                            {
                                type: "POST",
                                url: "theory_attendence_insert_code_backend.php",
                                data: {
